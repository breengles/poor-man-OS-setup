...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- Fix warning: multiple different client offset_encodings (ruff + pyright)
      ...
      local servers = {
        ...
        pyright = {
          ...
          settings = {
            ...
            python = {
              analysis = {
                -- Disable type checking diagnostics (ruff handles linting)
                -- Pyright still provides go-to-definition, references, completions
  ...
  -- NOTE: Custom colorscheme is loaded from lua/custom/plugins/mycolorscheme.lua
  -- If you want to use a different colorscheme, you can uncomment this block:
