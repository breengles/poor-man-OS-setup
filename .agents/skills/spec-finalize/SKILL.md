...
existing `docs/*.md` for the touched components, plus `README.md`/`AGENTS.md` if the
...
`AGENTS.md` are the only doc surface (and thus the only things to reconcile) before
continuing.
...
- Instruction to edit **only documentation** (`docs/`, `README.md`, `AGENTS.md`) -- never
  source code.
