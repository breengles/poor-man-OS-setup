...
Also skim the repo (README, top-level directories, AGENTS.md/AGENTS.md, any neighboring
...
- Respect project language/stack conventions from AGENTS.md (Python: `uv`, ruff 120, Pyright
